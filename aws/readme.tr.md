...
AWS altyapısının Infrastructure as Code yaklaşımıyla yönetilmesi amacıyla Terraform kullanılmıştır.

Mevcut AWS kaynakları Terraform state içerisine alınmış ve altyapının deklaratif olarak yönetilmesi sağlanmıştır.

### Terraform kapsamında
...
Terraform ile altyapının mevcut durumunun kontrol edilmesi ve değişikliklerin deployment öncesinde planlanması gerçekleştirilmiştir.
